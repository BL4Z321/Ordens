...
def listar_produtos(request):
    ...
    return render(request, 'gestor/produtos/produtos.html', contexto)
...
def criar_produto(request):
    ...
    return render(request, 'gestor/produtos/novo_produto.html', contexto)
...
def editar_produto(request, pk):
 ...
 return render(request, 'gestor/produtos/editar_produto.html', contexto)
...
def excluir_produto(request, pk):
    ...
    return render(request, 'gestor/produtos/excluir_produto.html', {'produto': produto})